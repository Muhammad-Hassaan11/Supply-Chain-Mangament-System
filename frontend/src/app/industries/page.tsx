...
const industries = [
  ...
  ["Food & Beverages", "Batch visibility, regional distribution, and temperature-aware operations.", "https://images.unsplash.com/photo-1601593768790-4f029d8f0b85?auto=format&fit=crop&w=900&q=80"],
  ["Chemicals", "Hazard-aware storage, compliance records, and careful shipment logs.", "https://images.unsplash.com/photo-1581093458791-9f3c3900df7b?auto=format&fit=crop&w=900&q=80"],
