...
const industries = [
  ...
  ["Food & Beverages", "Batch visibility, regional distribution, and temperature-aware operations.", "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=900&q=80"],
  ["Chemicals", "Hazard-aware storage, compliance records, and careful shipment logs.", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=900&q=80"],
